...
const fadeDuration = 4000; // フェードアウト完了までの時間（ミリ秒）
...
window.addEventListener('scroll', () => {
    ...
    if (scrollY > triggerScroll) {
        // document.getElementById("mv-mask").classList.remove("mask");
    }
});
...
//     let scalex = 2;
//     let scaley = 2; // 初期のスケール

//     if (elapsed <= fadeDuration) {
//         // 経過時間に応じて拡大とフェードアウトを計算
//         scalex = 2 + (elapsed / fadeDuration) * 2; // 1 から 3 まで拡大
//         scaley = 2 + (elapsed / fadeDuration) * 2; // 1 から 3 まで拡大
